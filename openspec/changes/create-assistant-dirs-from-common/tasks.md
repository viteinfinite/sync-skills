...
- [x] 1.11 Add integration test: "Scenario: Only .sync-skills exists - should create assistant directories with @ references" in `test/integration.test.ts`

- [x] 1.12 Add integration test: "Scenario: Only .sync-skills exists with --home - should create home assistant directories with @ references" in `test/integration.test.ts`
...
- [ ] 2.1 Manual test: Create a test directory with only `.sync-skills` configured for claude and gemini, run `sync-skills`, verify directories are created
