...
Given a project with skills in `.claude/skills/my-skill` and `.sync-skills/skills/my-skill`
...
Given a directory with assistant folders but no `.sync-skills/config.json`
When I run `sync-skills --list`
