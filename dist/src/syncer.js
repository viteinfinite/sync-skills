...
export async function writePlatformReference(platformPath, commonPath) {
    ...
    const commonCore = pickCoreFrontmatter(commonParsed.data);
    const commonMetadata = commonCore.metadata;
    ...
    const newPlatformData = { ...commonCore };
